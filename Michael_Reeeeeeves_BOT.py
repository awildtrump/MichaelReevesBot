...
quotes = [
    ...
    ["https://www.youtube.com/watch?v=DvrkHAWj1Sk&t=6s", "2019", "I'm very short.", 0x11cc11]
]
...
async def on_message(message):
    ...
    if message.content.startswith("$reeves quote"):
        ...
        embedVar = discord.Embed(title=currentQuote[2], color=currentQuote[3])
        embedVar.add_field(name="On video:", value=currentQuote[0], inline=False)
        embedVar.set_footer(text="Michael Reeves -" + currentQuote[1], icon_url="https://vignette.wikia.nocookie.net/youtube/images/d/d1/Michaelreevesicon.jpeg/revision/latest?cb=20200216070831")
...
#remove this before pushing to origin
client.run("")